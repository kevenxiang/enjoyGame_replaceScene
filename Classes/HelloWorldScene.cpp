...
bool HelloWorld::init()
{
    ...
    auto sprite_01 = Sprite::create("HelloWorld.png");
    sprite_01->setPosition(Vec2(200, 200));
    this->addChild(sprite_01);
...
//    Director::getInstance()->replaceScene(TransitionJumpZoom::create(3.0f, SecondScene::createScene()));
